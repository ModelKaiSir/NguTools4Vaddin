package com.ngu.server.views.dashboard;

import com.ngu.server.data.entity.SamplePerson;
import com.ngu.server.data.service.SamplePersonService;
...
public class DashboardView extends Div implements BeforeEnterObserver {
    ...
    public DashboardView(@Autowired SamplePersonService samplePersonService) {
